...
echo $id = $usuario = $_GET['id'];
$espaco_livre = $repositorio->MostrarInventario($id);
foreach ($espaco_livre as $key) {
    ...
    foreach ($copiar_inventario as $key) {
        echo $id_inventario = $key['id_inventario'];
        echo $id_usuario = $key['id_usuario'];
        echo $nome_pers = $key['nome_pers'];
        echo $item1 = $key['item1'];
        echo $item2 = $key['item2'];
        echo $item3 = $key['item3'];
        echo $item4 = $key['item4'];
        echo $item5 = $key['item5'];
        echo $item6 = $key['item6'];
        echo $item7 = $key['item7'];
        echo $item8 = $key['item8'];
        echo $item9 = $key['item9'];
        echo $item10 = $key['item10'];
        echo $item11 = $key['item11'];
        echo $item12 = $key['item12'];
        echo $item13 = $key['item13'];
        echo $item14 = $key['item14'];
        echo $item15 = $key['item15'];
        echo $item16 = $key['item16'];
        echo $item17 = $key['item17'];
        echo $item18 = $key['item18'];
        echo $item19 = $key['item19'];
        echo $item20 = $key['item20'];
        echo $item21 = $key['item21'];
        echo $item22 = $key['item22'];
        echo $item23 = $key['item23'];
        echo $item24 = $key['item24'];
        echo $item25 = $key['item25'];
    }
...
foreach ($personagem as $key) {
    echo $nome = $usuario = $key['nome'];
    $copiar_inventario = $repositorio->MostrarInventario($nome);
    foreach ($copiar_inventario as $key) {

        if($_SESSION['item'] == $key['item1']){
            $apagar = "item1";
        } else if($_SESSION['item'] == $key['item2']){
            $apagar = "item2";
        } else if($_SESSION['item'] == $key['item3']){
            $apagar = "item3";
        } else if($_SESSION['item'] == $key['item4']){
            $apagar = "item4";
        } else if($_SESSION['item'] == $key['item5']){
            $apagar = "item5";
        } else if($_SESSION['item'] == $key['item6']){
            $apagar = "item6";
        } else if($_SESSION['item'] == $key['item7']){
            $apagar = "item7";
        } else if($_SESSION['item'] == $key['item8']){
            $apagar = "item8";
        } else if($_SESSION['item'] == $key['item9']){
            $apagar = "item9";
        } else if($_SESSION['item'] == $key['item10']){
            $apagar = "item10";
        } else if($_SESSION['item'] == $key['item11']){
            $apagar = "item11";
        } else if($_SESSION['item'] == $key['item12']){
            $apagar = "item12";
        } else if($_SESSION['item'] == $key['item13']){
            $apagar = "item13";
        } else if($_SESSION['item'] == $key['item14']){
            $apagar = "item14";
        } else if($_SESSION['item'] == $key['item15']){
            $apagar = "item15";
        } else if($_SESSION['item'] == $key['item16']){
            $apagar = "item16";
        } else if($_SESSION['item'] == $key['item17']){
            $apagar = "item17";
        } else if($_SESSION['item'] == $key['item18']){
            $apagar = "item18";
        } else if($_SESSION['item'] == $key['item19']){
            $apagar = "item19";
        } else if($_SESSION['item'] == $key['item20']){
            $apagar = "item20";
        } else if($_SESSION['item'] == $key['item21']){
            $apagar = "item21";
        } else if($_SESSION['item'] == $key['item22']){
            $apagar = "item22";
        } else if($_SESSION['item'] == $key['item23']){
            $apagar = "item23";
        } else if($_SESSION['item'] == $key['item24']){
            $apagar = "item24";
        } else if($_SESSION['item'] == $key['item25']){
            $apagar = "item25";
        }
